...
export const AdminLogsPage = () => {
  ...
  const getActionColor = (acao: string) => {
    switch (acao) {
      case 'CRIAR': return 'text-emerald-400 bg-emerald-500/10 border-emerald-500/20';
      case 'EDITAR': return 'text-amber-400 bg-amber-500/10 border-amber-500/20';
      case 'EXCLUIR': return 'text-rose-400 bg-rose-500/10 border-rose-500/20';
